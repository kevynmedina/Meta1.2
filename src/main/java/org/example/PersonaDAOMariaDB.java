...
public class PersonaDAOMariaDB implements IPersonaDAO {
    ...
    public void insertarPersona(String nombre, List<Direccion> direcciones, List<String> telefonos) throws SQLException {
        try (Connection conn = getConnection();
    ...
    public void actualizarPersona(int id, String nombre, List<Direccion> direcciones, List<String> telefonos) throws SQLException {
        try (Connection conn = getConnection();
             PreparedStatement ps = conn.prepareStatement(
